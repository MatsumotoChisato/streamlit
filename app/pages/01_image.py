...
### ブドウ粒数カウント
'''
uploaded_image=st.file_uploader("ブドウ画像をアップロードしてください", type=['png', 'jpg', 'jpeg'])
...
with col1:
    ...
    if uploaded_image is not None:
        ...
        #######################################    
        if radio=="gray" and uploaded_image is not None:
            canny_gray = blur
        elif radio=="canny" and uploaded_image is not None:
        ...
        #円の合計数を表示
        col2.subheader("reselt 検出粒数　："+ str(j))       
        col2.image(img)
